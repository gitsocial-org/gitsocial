...
func objectSize(client *objstore.Client, key string) (int, bool, error) {
...
func planBodies(client *objstore.Client, prefix, ext string, bodies []siteBodyEntry, sp *siteProgress) (shardPlan[siteBodyEntry], error) {
...
func planBodiesAppend(client *objstore.Client, prefix, ext string, gap, headItems []siteBodyEntry, manifest *siteShardManifest, sp *siteProgress) (shardPlan[siteBodyEntry], error) {
...
func planBodiesTail(client *objstore.Client, prefix, ext string, keptShards []siteShardEntry, tail []siteBodyEntry, sp *siteProgress) (shardPlan[siteBodyEntry], error) {
	return planTail(client, bodiesCorpus, prefix, ext, keptShards, tail, sp)
}

// putBodiesHead writes a bodies plan's head document.
func putBodiesHead(client *objstore.Client, prefix, ext, tip string, plan *shardPlan[siteBodyEntry]) error {
...
func putBodiesManifest(client *objstore.Client, prefix, ext, tip string, plan shardPlan[siteBodyEntry], complete bool) (int, error) {
...
func readBodiesManifest(client *objstore.Client, prefix, ext string) (*siteShardManifest, error) {
	return readShardManifest(client, bodiesCorpus, prefix, ext)
}

// readBodyDocItems fetches a bodies document's items.
func readBodyDocItems(client *objstore.Client, key string) ([]siteBodyEntry, error) {
...
func deleteBodiesSharded(client *objstore.Client, prefix, ext string) error {
