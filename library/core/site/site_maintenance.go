...
func updatePushedSiteItems(out objstore.PushOutcome, src *objstore.LocalCommitSource) {
	client, prefix := out.Client, out.Prefix
...
func reclaimSitePagesFront(client *objstore.Client, prefix string, refs map[string]string, ov objstore.SiteOverride, src *objstore.LocalCommitSource) (ok bool) {
