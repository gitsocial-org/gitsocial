...
func readSitePagesMeta(client *objstore.Client, prefix, ext string, items *siteShardManifest) ([]sitePageMsg, error) {
...
func readSitePagesCorpus(client *objstore.Client, prefix, ext string, items *siteShardManifest) ([]sitePageMsg, error) {
...
func attachThreadBodies(client *objstore.Client, prefix string, affected []*sitePageItem) error {
...
func attachRootBodies(client *objstore.Client, prefix string, items []*sitePageItem) error {
...
func attachMsgBodies(client *objstore.Client, prefix string, msgs []*sitePageMsg) error {
...
func readBodiesBySHAs(client *objstore.Client, prefix, ext string, need map[string]bool) (map[string]string, error) {
...
func readAllShardEntries[E shardEntry](client *objstore.Client, prefix, ext string, corpus shardCorpus[E], manifest *siteShardManifest) ([]E, error) {
	var out []E
