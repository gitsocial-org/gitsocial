...
func seedSiteBucket(t *testing.T, client *objstore.Client) {
	t.Helper()
...
func TestPushSite_CorruptMarkerFallsBack(t *testing.T) {
	...
	upToDate, _ := siteMaintenanceUpToDate(client, "", mustSiteVersion(t), objstore.SiteOverride{})
	if upToDate {
