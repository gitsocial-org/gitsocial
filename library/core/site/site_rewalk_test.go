// site_rewalk_test.go - the rewalk verdict: a run that completes an items index does
...
func countWalkedCommits(t *testing.T, client *objstore.Client, tip string) int {
	t.Helper()
	const ext = "social"
	var peak int
