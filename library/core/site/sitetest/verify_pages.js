...
const HTML = fs.readFileSync(require("path").join(__dirname, "../assets/index.html"), "utf8");
...
const CSS = fs.readFileSync(require("path").join(__dirname, "../assets/pages-core.css"), "utf8") + "\n" + fs.readFileSync(require("path").join(__dirname, "../assets/pages-full.css"), "utf8");
const APP = fs.readFileSync(require("path").join(__dirname, "../assets/gs-app.js"), "utf8");
