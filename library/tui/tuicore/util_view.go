...
var (
	...
	PMIssueHistoryDiff     = RegisterContext("pm.issue_history_diff")
	...
	PMMilestoneHistoryDiff = RegisterContext("pm.milestone_history_diff")
	...
	PMSprintHistoryDiff    = RegisterContext("pm.sprint_history_diff")
)
